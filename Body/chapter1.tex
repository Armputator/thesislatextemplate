...
\centering
\fbox{
    \includegraphics[width=0.75\textwidth]{../resources/HochschuleMuenchenLogo-1200x521.png}
}
...
\begin{figure}[H]
    ...
    \fbox{
        \subfloat[Chalpr SX-2]{
            \includegraphics[width=0.45\textwidth]{../resources/HochschuleMuenchenLogo-1200x521.png}
        }
